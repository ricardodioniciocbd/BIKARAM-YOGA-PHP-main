    ...
    <li class="breadcrumb-item active" aria-current="page">Actualizar</li>
                            ...
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Actualizar imagen del plan reciente añadidos el dia de hoy</p>
                                </div>
  ...
  <div class="col-md-12 col-lg-12">
   ...
   <input type="hidden" value="<?php echo  $f->idplan  ; ?>" name="txtidc">
    ...
    <div class="row">
      <div class="col-md-12 col-lg-12">
    <div class="form-group">
    <label for="email">Foto del plan<span class="text-danger">*</span></label>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdplanft' class="btn btn-success text-white">Guardar</button>                       
...
<?php endforeach; ?>
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   <?php
    include_once '../../backend/php/st_updplnft.php'
?>
